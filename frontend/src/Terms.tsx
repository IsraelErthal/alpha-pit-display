export function Terms() {
  return <article className="terms-content">
    ...
    <h3>Retenção</h3>
    <p>Os registros de acesso são excluídos automaticamente após 90 dias. Comentários e os dados de autoria vinculados a eles são mantidos enquanto necessários para moderação, segurança e operação do mural.</p>
    <h3>Suas escolhas</h3>
    <p>Você pode continuar navegando e comentando sem aceitar. Nesse caso, não registramos o acesso e não ativamos recursos analíticos. Para dúvidas ou solicitações sobre dados, contate a equipe Alpha Scuderia.</p>
  </article>;
}
